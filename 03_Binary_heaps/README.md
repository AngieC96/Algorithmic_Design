...
If you don't do it, the library and its headers will be installed in `/usr/local/`. I've chosen the folder `~/Documenti/AlgorithmicDesign/Algorithmic_Design/03_Binary_heaps`.
